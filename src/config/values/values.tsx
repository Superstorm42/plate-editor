...
const align: any = (
  <fragment>
    ...
    <hp align="right">This block text is aligned to the right. PARAGRAPH</hp>
    <hh2 align="center">Center</hh2>
    <hp align="justify">This block text is justified. PARAGRAPH</hp>
  </fragment>
)
...
const createHugeDocument = () => {
  ...
  for (let h = 0; h < HEADINGS; h++) {
    hugeDocument.push(<hh1>SENTENCE</hh1>)

    for (let p = 0; p < PARAGRAPHS; p++) {
      hugeDocument.push(<hp>PARAGRAPH</hp>)
    }
  }
